...
class InstallController extends Controller
{
    ...
    public function store(InstallRequest $request)
    {
        ...
        $content = "APP_ENV=local\nAPP_KEY=base64:DwoRcAiwzD9qjktcg9h/wClATyE+5Xk7K1QbsM6lD7w=\nAPP_DEBUG=true\nAPP_LOG_LEVEL=debug\nAPP_URL=http://localhost\n\nDB_CONNECTION=mysql\nDB_HOST=$host\nDB_PORT=3306\nDB_DATABASE=$database_name\nDB_USERNAME=$username\nDB_PASSWORD=$password\n\nBROADCAST_DRIVER=log\nCACHE_DRIVER=file\nSESSION_DRIVER=file\nQUEUE_DRIVER=sync\n\nREDIS_HOST=127.0.0.1\nREDIS_PASSWORD=null\nREDIS_PORT=6379\nMAIL_DRIVER=mail\n\nINSTALLED=1\n";
    ...
    public function checkFolders() // check folder permission
    {
        ...
        $dirs = array('app', 'storage', 'storage/app', 'storage/framework', 'storage/framework/sessions', 'storage/framework/cache', 'storage/logs', 'resources/lang', 'database/migrations', 'database/seeds');
