...
<head>
    <meta charset="UTF-8">
    <title> Office Attendance System | Installation </title>
        ...
        <div class="col-md-6 col-md-offset-3 " style=" padding-top: 10px;">
            <div class="panel panel-primary room">
                <div class="panel-heading">
                    <strong>
                        Office Attendance System | Installation
                    </strong>
                </div>
                ...
                <div class="panel-footer"><a target="_blank" href="http://www.fb.com/lincolndu" style="color: #333"> ©
                        lincoln mahmud</a>
                </div>
            </div>
